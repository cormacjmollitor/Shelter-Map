...
function getSearchRequest(req, res) {
    ...
    var take = req.body.take ? req.body.take : defaultTake;
    ...
    if (orderBy === searchRequest_1.OrderBy.Distance && ((typeof latitude) !== "number" || (typeof longitude) !== "number" ||
        latitude < -90 || latitude > 90 || longitude < -180 || longitude > 180)) {
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (search.longitude && search.latitude) {
                        innerQueryBuilder.addSelect("(point(:longitude, :latitude) <@> point(job.longitude, job.latitude)) * 1.609344", "job_distance")
...
function addOrderBy(search, qb) {
    switch (search.orderBy) {
        case searchRequest_1.OrderBy.Distance:
            ...
            break;
        case searchRequest_1.OrderBy.Relevance:
        default:
